...
const Home = () => {
  return (
    ...
    <img src="https://thumbor.forbes.com/thumbor/fit-in/1290x/https://www.forbes.com/advisor/wp-content/uploads/2023/07/top-20-small-dog-breeds.jpeg.jpg"
          className='w-screen h-screen' alt=" images " />

     {/* SUBHEADING */}
<div className='flex flex-col items-center text-slate-600 bg-white py-16'>
        <h3 className='text-3xl font-extrabold tracking-wide '>India’s street animals need help, rescue and rehabilitation. Help us Help them.</h3>
      </div>
...
<div class=" lg:py-6 px-4 mx-auto w-screen bg-sky-950 flex-col items-center ">
        ...
        <p class="mb-8 lg:mb-16 font-light  text-center text-white  text-2xl">
          ...
          pets in need of a <br />forever home, while also providing emergency medical
          care for stray animals <br />in distress. We strive to make a difference in
          the lives of these  innocent creatures<br /> by offering options to adopt , report
          stray animals in need of immediate <br />assistance. Together, we can create
        ...
        {/* GREY ANIMALS */}
          <div className='flex justify-evenly mb-3 mt-4'>
                <div className='flex flex-col items-center pb-4'>
                      ...
                      <NavLink to="/Adopt"
                            className={({isActive}) =>
                                    ` ${isActive ? "text-3xl text-sky-950 font-extrabold mb-5   " : "text-3xl text-sky-950 font-extrabold mb-5"}  text-3xl text-sky-950 font-extrabold mb-5 `
                            }
                        >
                            ADOPT
                        </NavLink>
                      <p className='text-lg text-slate-500 font-small'>  &nbsp; Even if you can't adopt please give
                ...
                <div className='flex flex-col items-center pb-4 '>
                      ...
                      <p className='text-lg text-slate-500 font-small'> &nbsp;Our animals are lovable characters,
         ...
         {/* MEET OUR FRIENDS */}
   <div id="meet"className='w-full bg-black  text-white flex justify-center py-7 text-5xl font-semibold tracking-wide'>MEET OUR FRIENDS HERE</div>
